...
import com.beyond.staticmember.practice.InitBlock;
...
//        System.out.printf("int의 범위: %d ~ %d", Integer.MIN_VALUE, Integer.MAX_VALUE);
        ...
        // 필드 초기화 순서
        // 1. 일반 필드
        System.out.println(new InitBlock().getName());  // null(기본값) -> 홍길동(명시) -> 이몽룡(인스턴스 블록) -> 임꺽정(생성자)
        // 2. static 필드
        System.out.println(InitBlock.getAge());
